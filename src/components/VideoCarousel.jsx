    ...
    const handleProcess = (type, i) => {
        switch (type) {
            ...
            case 'video-reset':
                ...
                break;
            case 'play':
                setVideo((prev) => ({ ...prev, isPlaying: !video.isPlaying }))
                break;
            case 'pause':
                setVideo((prev) => ({ ...prev, isPlaying: !video.isPlaying }))
                break;
            ...
            <div className='relative flex-center mt-10'>
                <div className="flex-center py-5 px-7 bg-gray-300 backdrop-blur rounded-full">
                    {videoRef.current.map((_, i) => (
                        <span className='mx-2 w-3 h-3 bg-gray-200 rounded-full relative cursor-pointer' ref={(el) => (videoDivRef.current[i] = el)} key={i}>
